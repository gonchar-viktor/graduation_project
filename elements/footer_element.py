...
class FooterElement(Assertion, FieldsWebElement, FooterLocators):
    ...
    text_information_block = (
        "Указанные контакты являются в том числе контактами для связи по "
        "вопросам обращения покупателей о нарушении их прав. Лица, "
        "уполномоченные рассматривать обращения покупателей о нарушении их "
        "прав - Белокурская А.А., Волк А.В., Ганисевская В.С. Номер телефона "
        "работников местных исполнительных и распорядительных органов по "
        "месту государственной регистрации ООО «Триовист», уполномоченных "
        "рассматривать обращения покупателей: +375 17 374 01 46.\nВ торговом "
        "реестре с 23 июня 2010 г., № регистрации 156473, УНП 190806803, "
        "регистрация №190806803, 22.02.2007, Мингорисполком.\n© 2004–2023 "
